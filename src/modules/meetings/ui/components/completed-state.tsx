                ...
                <div className="bg-white rounded-lg border px-3">
                    <ScrollArea>
                        <TabsList className="p-0 bg-background justify-start rounded-none h-13">
                            <TabsTrigger
                                value="summary"
                                className="text-muted-foreground rounded-one bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
                            >
                                <BookOpenTextIcon />
                                Summary
                            </TabsTrigger>
                ...
                <TabsContent value="recording">
                    <div className="bg-white rounded-lg border px-4 py-5">
                        ...
                        controls>
                            ...
                            <div className="text-center py-4 text-muted-foreground"> Recording has expired </div> )}
                    </div>
                    ...
                    <div className="bg-white rounded-lg border">
                        <div className="px-4 py-4 gap-y-5 flex flex-col col-span-5"> 
                            ...
                            <Link href={`/agents/${data.agent.id}`} className="flex items-center gap-x-2 underline underline-offset-4 capitalize">
                                <GeneratedAvatar
                                    variant="botttsNeutral" seed={data.agent.name} className="size-5"
                                /> {data.agent.name}
                            </Link>{" "}
